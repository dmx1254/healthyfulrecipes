...
import { getThreeLatestLifeStyles } from "@/lib/api/posts";
import { ArticleResponse } from "@/lib/type";
import Link from "next/link";
// import { timeAgo } from "@/lib/utils";

const HomeLifestyleItem = async () => {
  const articles: ArticleResponse[] = await getThreeLatestLifeStyles();
...
export default HomeLifestyleItem;
