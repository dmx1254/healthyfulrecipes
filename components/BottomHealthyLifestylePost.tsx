...
const BottomHealthyLifestylePost = async ({ slug }: { slug: string }) => {
      ...
      {posts?.map((post) => (
        ...
        >
          ...
          <div className="w-full flex flex-col items-start gap-2 lg:p-2">
            <p className="w-full max-lg:hidden text-xs text-zinc-500 truncate">
              {post?.descriptions}
            </p>
...
export default BottomHealthyLifestylePost;
